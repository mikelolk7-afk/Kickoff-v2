    ...
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 text-center">
        ...
        <div className="flex gap-4">
          ...
          <Link
            href="/login"
            className="px-8 py-3 border border-border text-foreground rounded-lg font-semibold text-lg hover:bg-surface/50 transition-colors"
          >
            Sign In
          </Link>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-panel rounded-lg border border-border p-6 text-center">
      ...
      {/* Footer */}
      <footer className="border-t border-border py-4 text-center text-subtle text-sm">
